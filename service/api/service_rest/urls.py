...
from .views import api_list_technicians, api_delete_technician, api_list_appointments, api_delete_appointment, api_finish_appointment
...
urlpatterns = [
     ...
     path("api/appointments/<int:pk>", api_finish_appointment,
